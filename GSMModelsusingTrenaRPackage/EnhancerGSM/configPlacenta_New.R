...
#matrix.name <- "RNAseqData" ##Only Yoels Data
matrix.name<-"TrainingDataForServer" ## Full Dataset
...
OUTPUTDIR <- "/proj/price4/apaquett/TRENA_GSMs/GSM_Full82019"
if(!file.exists(OUTPUTDIR))
   dir.create(OUTPUTDIR)

WORKERS <- 10 # changed from 20 for now
